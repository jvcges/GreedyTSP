...
class GreedyTSP(Experimento):

	def __init__(self, args):
		super().__init__(args)
		self.id = "i"
		self.script = "greedyTSP.py"
...
def main():
	...
	help_msg = "algoritmos (t=tsp naive, s=selection sort, i=insertion sort) ou nenhum para executar todos.  Padrão:{}".format(DEFAULT_ALGORITMOS)
